...
const DetallesEntornos = () => {
  ...
  const handlePreviousTrack = () => {
    const prevIndex = (currentTrackIndex - 1 + trackMetadata.length) % trackMetadata.length;
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-4">
      {/* Control de Iluminación (columna izquierda) */}
      ...
      {/* Columna derecha - Temperatura, Ventilación y Música apilados */}
      <div className="flex flex-col gap-6">
        {/* Control de Temperatura */}
        <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-[#D3E3E6] hover:shadow-xl transition-shadow duration-300">
          <div className="p-6">
            <h2 className="text-2xl font-bold mb-4 text-[#5985B1] text-center">Temperatura</h2>
            
            <div className="flex flex-col items-center mb-4">
              {getTemperatureIcon()}
              <div className="mt-4 text-4xl font-bold text-[#5985B1]">
                {temperature}°C
              </div>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-[#D3E3E6] hover:shadow-xl transition-shadow duration-300">
          <div className="p-6">
            <h2 className="text-2xl font-bold mb-4 text-[#5985B1] text-center">Ventilación</h2>
            
            <div className="flex flex-col items-center mb-4">
              <div className="relative w-24 h-24 flex items-center justify-center">
                <div className="absolute w-20 h-20 rounded-full bg-[#D3E3E6] border-4 border-[#5985B1] flex items-center justify-center">
                  <div className="w-6 h-6 rounded-full bg-[#5985B1]"></div>
                </div>
                ...
                >
                  <div className="absolute top-1/2 left-1/2 w-20 h-3 bg-[#5985B1] rounded-full" 
                    style={{ transform: 'translate(-50%, -50%) rotate(0deg) translateX(16px)' }}></div>
                  <div className="absolute top-1/2 left-1/2 w-20 h-3 bg-[#5985B1] rounded-full" 
                    style={{ transform: 'translate(-50%, -50%) rotate(120deg) translateX(16px)' }}></div>
                  <div className="absolute top-1/2 left-1/2 w-20 h-3 bg-[#5985B1] rounded-full" 
                    style={{ transform: 'translate(-50%, -50%) rotate(240deg) translateX(16px)' }}></div>
                </div>
                
                <div className="absolute -bottom-2 -right-2 px-2 py-1 bg-[#5985B1] text-white font-semibold rounded-full text-xs">
                  {ventilation}
                </div>
              </div>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-[#D3E3E6] hover:shadow-xl transition-shadow duration-300">
          <div className="p-6">
            <h2 className="text-2xl font-bold mb-4 text-[#5985B1] text-center">Música</h2>

            {trackMetadata.length > 0 && (
              <div className="mb-4 text-center">
                <p className="text-lg font-semibold text-[#5985B1] truncate px-2">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-2 sm:gap-4">
              <button
                ...
                className="w-full sm:w-auto px-3 py-2 bg-[#5985B1] text-white font-semibold rounded-lg shadow-md hover:bg-[#476a8c] transition-colors duration-300 text-sm sm:text-base"
              >
                Anterior
              </button>
              <button
                ...
                } text-white font-semibold rounded-lg shadow-md hover:opacity-90 transition-colors duration-300 text-sm sm:text-base`}
              >
...
export default DetallesEntornos;